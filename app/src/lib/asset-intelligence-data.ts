...
export const assetProfiles: AssetProfile[] = [
  {
    ...
    seoDescription: "Understand Bitcoin, why traders watch BTC, what moves it, and how Lurnava studies it through structured market education.",
    publicHeadline: "Bitcoin is the market's crypto reserve asset.",
    publicSubheadline:
      "BTC is watched because it sits at the center of crypto liquidity, institutional flows, miner behavior, and macro risk appetite.",
    plainEnglish:
      "Bitcoin is a decentralized digital asset with a fixed issuance schedule. It is often treated as crypto's main reserve asset because many traders, funds, exchanges, and long-term holders use it as the market reference point.",
    marketRole:
      "Bitcoin often sets the temperature for the wider crypto market. When BTC liquidity expands or contracts, many altcoins react because traders use Bitcoin as the first read on crypto demand.",
    whyTradersWatch:
      "Traders watch Bitcoin to understand crypto risk appetite, ETF flow pressure, miner stress, long-term holder behavior, and whether capital is rotating into or out of digital assets.",
    lurnavaMonitorNote:
      "Lurnava studies Bitcoin through liquidity, exchange flow, miner pressure, ETF demand, volatility structure, and key historical behavior. The goal is to teach learners how BTC moves before they try to trade assets linked to it.",
    conversionCta:
    ...
    sources: [assetResearchSources.bitcoinWhitepaper, assetResearchSources.bitcoinDeveloperGuide],
    drivers: [
      { title: "ETF and institutional demand", detail: "Spot products and institutional desks can change the pace of Bitcoin demand, especially when flows persist for several sessions." },
      { title: "Miner economics", detail: "Mining cost, hash rate, halving cycles, and miner selling can affect available supply and market pressure." },
      { title: "Liquidity and risk appetite", detail: "Bitcoin reacts strongly when global liquidity expectations, interest-rate expectations, or broad risk appetite shift." },
      { title: "Exchange flow", detail: "Large deposits, withdrawals, and stablecoin balances help learners study whether BTC is being prepared for sale, custody, or fresh deployment." },
    ],
    publicRisks: [
    ...
    lab: {
      deskBrief:
        "Bitcoin is the primary crypto asset for studying market-wide liquidity. The Asset Lab treats BTC as a dashboard for institutional demand, miner stress, exchange inventory, derivatives leverage, and macro risk conditions.",
      researchQuestion:
        "Is Bitcoin being accumulated, distributed, repriced by macro conditions, or pulled by derivatives positioning?",
      operatingModel:
        "Study BTC in layers: spot flow first, derivatives pressure second, macro context third, and long-term holder behavior as the slow anchor.",
      participants: [
        { name: "Long-term holders", role: "Supply anchor", whyItMatters: "Their spending or holding behavior changes the amount of BTC that can reach the market." },
        { name: "ETF issuers and institutional desks", role: "Demand channel", whyItMatters: "Persistent inflows or outflows can add directional pressure beyond retail activity." },
        { name: "Mining companies", role: "Production source", whyItMatters: "Miner revenue stress can increase selling pressure after difficulty, price, or halving shifts." },
        { name: "Derivatives venues", role: "Leverage layer", whyItMatters: "Open interest, funding, and liquidation maps show where forced moves may appear." },
      ],
      historicalEvents: [
        ...
        { year: "2021", title: "Institutional cycle expands", detail: "Public companies, funds, and futures products make Bitcoin more visible to traditional markets." },
        { year: "2024", title: "US spot ETFs begin trading", detail: "ETF access changes how many institutions can gain Bitcoin exposure." },
      ],
      correlations: [
      ...
      researchRoutine: [
        ...
        "Review ETF flows, exchange inflows, and exchange reserves.",
        ...
        "Record whether the move is spot-led, leverage-led, or macro-led.",
      ],
  ...
  },
  {
    ...
    seoDescription: "Learn why the US Dollar matters, what moves USD, and how Lurnava studies the world's main reserve currency.",
    publicHeadline: "The US Dollar is the anchor of global currency markets.",
    publicSubheadline:
      "USD is watched because global trade, reserves, debt, commodities, and risk appetite often pass through dollar pricing.",
    plainEnglish:
      "The US Dollar is the currency of the United States and the main reserve currency used across global trade and finance. Many assets are priced, borrowed, saved, or settled in dollars.",
    marketRole:
      "USD is the reference point for many currency pairs, commodities, and global risk decisions. When the dollar strengthens or weakens, it can affect forex pairs, gold, crypto, and emerging markets.",
    whyTradersWatch:
      "Traders watch USD because Federal Reserve policy, Treasury yields, inflation, employment data, and global stress can change demand for dollars quickly.",
    lurnavaMonitorNote:
      "Lurnava studies the dollar through interest-rate expectations, inflation, employment data, Treasury yields, liquidity demand, DXY behavior, and pair-specific context.",
    conversionCta:
    ...
    sources: [assetResearchSources.federalReservePolicy, assetResearchSources.bisFxSurvey],
    drivers: [
    ...
    lab: {
      deskBrief:
        "The US Dollar is studied as the central pricing unit for global macro. The Asset Lab connects Fed policy, yield curves, inflation data, labor data, risk stress, and pair structure.",
      researchQuestion:
        "Is USD moving because of US strength, foreign weakness, rate repricing, liquidity demand, or position unwind?",
      operatingModel:
        "Never read USD in isolation. Compare the dollar driver against the other currency in the pair, then check yields, data, risk tone, and session behavior.",
      participants: [
        { name: "Federal Reserve", role: "Policy anchor", whyItMatters: "Rate expectations and policy language are central to dollar demand." },
        { name: "US Treasury market", role: "Yield reference", whyItMatters: "Treasury yields help price dollar returns and global discount rates." },
        { name: "Global banks", role: "Liquidity channels", whyItMatters: "Dollar funding pressure often appears through banking and swap markets." },
        { name: "Corporates and reserve managers", role: "Structural demand", whyItMatters: "Trade, reserves, and hedging create persistent dollar flows." },
      ],
      historicalEvents: [
      ...
      researchRoutine: [
        ...
        "Write whether USD strength is policy-led, stress-led, or counterpart weakness.",
      ],
  ...
  },
  {
    ...
    seoDescription: "Learn what moves gold, why traders watch XAU, and how Lurnava studies real yields, central banks, USD, and safe-haven demand.",
    publicHeadline: "Gold is the market's old monetary mirror.",
    publicSubheadline:
      "Gold is watched because it reacts to real yields, central banks, inflation expectations, dollar strength, crisis demand, and long-term trust in money.",
    plainEnglish:
      "Gold is a scarce physical metal used in jewelry, technology, central-bank reserves, investment products, and trading markets. In markets, it often reflects how people feel about money, inflation, yields, and safety.",
    marketRole:
      "Gold sits between commodity, currency, and store-of-value behavior. It can react like a macro asset when real yields move, and like a safety asset when confidence weakens.",
    whyTradersWatch:
      "Traders watch gold for real-yield pressure, US Dollar behavior, central-bank buying, ETF flows, inflation expectations, geopolitical stress, and physical demand.",
    lurnavaMonitorNote:
      "Lurnava studies gold through real yields, dollar strength, central-bank demand, ETF flows, physical demand, event risk, and Gold-specific chart behavior.",
    conversionCta:
    ...
    sources: [assetResearchSources.worldGoldCouncilDemand, assetResearchSources.lbmaPrices],
    drivers: [
    ...
    lab: {
      deskBrief:
        "Gold is studied as a macro-sensitive store-of-value market. The Asset Lab links XAU behavior to real yields, USD, inflation expectations, central-bank demand, ETF flows, and event stress.",
      researchQuestion:
        "Is gold moving because real yields changed, the dollar repriced, central-bank demand strengthened, or risk stress created defensive demand?",
      operatingModel:
        "Gold requires a macro-first read and a chart-second read. The strongest study notes explain the macro driver, then show where price accepts or rejects that idea.",
      participants: [
        { name: "Central banks", role: "Reserve buyers", whyItMatters: "Official buying can support long-term demand and change how traders frame gold." },
        { name: "ETF issuers and funds", role: "Investment access channel", whyItMatters: "ETF flows can reveal whether investors are adding or removing gold exposure." },
        { name: "Jewelry and physical buyers", role: "Physical demand base", whyItMatters: "Physical demand can matter around price extremes and regional cycles." },
        { name: "Macro funds", role: "Real-yield and dollar traders", whyItMatters: "Gold often reacts when funds reprice rates, inflation, and USD exposure." },
      ],
      historicalEvents: [
      ...
      researchRoutine: [
        ...
        "Scan central-bank, ETF, and physical demand context.",
        "Mark event risk and volatility zones before studying entries.",
        "Write whether the move is yield-led, dollar-led, demand-led, or stress-led.",
      ],
