  ...
  return (
    <div className="min-h-screen bg-[var(--ln-bg)] text-[var(--ln-text-primary)] overflow-x-hidden">
      ...
      <article className="pt-40 pb-20 px-6 lg:px-8 max-w-3xl mx-auto prose prose-slate prose-sm prose-headings:tracking-tight prose-headings:font-bold prose-headings:text-[var(--ln-navy-900)] prose-p:text-[var(--ln-text-secondary)] prose-p:leading-relaxed prose-li:text-[var(--ln-text-secondary)] prose-strong:text-[var(--ln-navy-900)]">
        ...
        <h1 className="!text-4xl !mb-4 !text-[var(--ln-navy-900)]">Privacy Policy</h1>
        ...
        <p>We collect data about your learning progress, test results, performance metrics, and activity on the platform. This data is essential to the functioning of the platform.</p>
        ...
        <ul>
          <li><strong>Platform Operation:</strong> To deliver course content, track progress, calculate scores, and maintain the learning experience.</li>
        ...
        <p>We implement industry-standard security measures including encryption in transit (TLS), secure authentication, and access controls.</p>
        ...
        <ul>
          ...
          <li>Export your learning history and progress data.</li>
        </ul>

        <h2>6. Data Retention</h2>
        <p>We retain your data for as long as your account is active. Upon account deletion, personal data is removed within 30 days.</p>
        ...
        <h2>10. Contact</h2>
        <p>For privacy-related inquiries, contact us at privacy@lurnava.com.</p>
      </article>
      <Footer />
    </div>
  );
