  ...
  return (
    <div className="min-h-screen bg-[#0B0E14] text-white overflow-x-hidden">
      ...
      <article className="pt-40 pb-20 px-6 lg:px-8 max-w-3xl mx-auto prose prose-invert prose-sm prose-headings:tracking-tight prose-headings:font-bold prose-p:text-[var(--color-text-secondary)] prose-p:leading-relaxed prose-li:text-[var(--color-text-secondary)] prose-strong:text-white">
        ...
        <p>Lurnava Academy provides online trading education, simulated trading environments, performance analytics, and certification services. The Service is educational in nature and does not constitute financial advice, brokerage, or investment management.</p>
        ...
        <p>All course content, curriculum design, strategy taxonomies, simulation engines, certification methodology, and platform software are the exclusive intellectual property of Lurnava Academy. You may not reproduce, distribute, modify, or create derivative works from any content without express written permission.</p>
        ...
        <p>Certifications are awarded based on demonstrated performance in the trading simulation. Certificate IDs are verifiable through our public verification system. Lurnava reserves the right to revoke certifications obtained through fraud, exploitation, or violation of these terms.</p>
        ...
        <p>Lurnava reserves the right to suspend or terminate your account at any time for violation of these terms. Upon termination, your access to course content and simulation will be revoked. Certification records remain in our system for verification purposes.</p>
