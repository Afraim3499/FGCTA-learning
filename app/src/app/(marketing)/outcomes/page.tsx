...
const skillStages = [
  ...
  { after: "L4–L5", title: "Market Mastery", skills: ["Trade market-exclusive strategies (carry, on-chain, gold macro, DeFi)", "Design multi-leg derivatives trades", "Read institutional order flow and liquidity", "Apply arbitrage and market making concepts"], color: "text-purple-400", bg: "bg-purple-500/10" },
  { after: "L6–L9", title: "Institutional Readiness", skills: ["Build complete risk frameworks for live capital", "Classify market regimes and select optimal strategies", "Combine strategies into multi-pillar confluence systems", "Execute with systematic discipline and emotional control"], color: "text-[var(--color-profit)]", bg: "bg-[var(--color-profit)]/10" },
];
    ...
    <div className="min-h-screen bg-[#0B0E14] text-white overflow-x-hidden">
      ...
      <section className="pt-40 pb-20 px-6 lg:px-8 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto space-y-6 relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter">What You Become</h1>
      ...
      <section className="bg-white/[0.02] py-20 px-6 lg:px-8 border-t border-white/5">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold tracking-tighter mb-10">What Certification Gets You</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { level: "Level 3", title: "Broker Referral", desc: "Unlocks at Strategy Operator. Transition from simulation to live trading with a real broker account." },
      ...
      <CTABanner headline="Start your transformation." subheadline="From zero to certified. Free Level 0 access — no card required." primaryLabel="Start Free Trial" primaryHref="/free-trial" secondaryLabel="View Pricing" secondaryHref="/pricing" />
      <Footer />
    </div>
  );
}
