...
export const forexCards: LessonCard[] = [
  {
    "type": "mission_brief",
    "title": "Forex roadway: Target Path Planning (1)",
    "label": "Forex Track Pillar",
    "visualKey": "forex-target-foundations",
    "body": "### Currency Relationship Adaptations\n\nIn Forex, currency pairs represent a relationship. The concept of **Target Path Planning** changes because we must coordinate base and quote pressure. We cross-check the US Dollar Index (DXY) to verify whether pair movement is broadly supported.\n\n* **FX Gating**: Align session open hours (London/NY) with the planning zone.",
    "context": {
      "keyTerms": [
        {
          "term": "DXY Alignment",
  ...
  {
    "type": "concept",
    "title": "Forex roadway: Target Path Planning (2)",
    "label": "Forex Track Pillar",
  ...
  {
    "type": "concept",
    "title": "Forex roadway: Target Path Planning (3)",
    "label": "Forex Track Pillar",
  ...
  {
    "type": "concept",
    "title": "Forex roadway: Target Path Planning (4)",
    "label": "Forex Track Pillar",
  ...
  {
    "type": "concept",
    "title": "Forex roadway: Target Path Planning (5)",
    "label": "Forex Track Pillar",
  ...
  {
    "type": "concept",
    "title": "Forex roadway: Target Path Planning (6)",
    "label": "Forex Track Pillar",
  ...
  {
    "type": "practice",
    "title": "Forex roadway: Target Path Planning (7)",
    "label": "Forex Track Pillar",
    "visualKey": "forex-target-foundations",
    "body": "### Currency Relationship Adaptations\n\nIn Forex, currency pairs represent a relationship. The concept of **Target Path Planning** changes because we must coordinate base and quote pressure. We cross-check the US Dollar Index (DXY) to verify whether pair movement is broadly supported.\n\n* **FX Gating**: Align session open hours (London/NY) with the planning zone.",
    "context": {
    ...
    "taskData": {
      "type": "choice_block",
      "question": "What is the disciplined Forex response for Target Path Planning?",
      "options": [
        {
          "id": "0",
  ...
  {
    "type": "summary",
    "title": "Forex roadway: Target Path Planning (8)",
    "label": "Forex Track Pillar",
    "visualKey": "forex-session-liquidity-targets",
    "body": "### Currency Relationship Adaptations\n\nIn Forex, currency pairs represent a relationship. The concept of **Target Path Planning** changes because we must coordinate base and quote pressure. We cross-check the US Dollar Index (DXY) to verify whether pair movement is broadly supported.\n\n* **FX Gating**: Align session open hours (London/NY) with the planning zone.",
    "context": {
