...
export const cryptoCards: LessonCard[] = [
  {
    "type": "mission_brief",
    "title": "Crypto roadway: Setup Anatomy (1)",
    "label": "Crypto Track Pillar",
    "visualKey": "crypto-plan-continuous-markets",
    "body": "### Digital Asset Adaptation\n\nCrypto markets are fragmented across multiple CEX/DEX venues. The concept of **Setup Anatomy** requires checking BTC dominance and perpetual funding rates. We map the spot-perp premium.\n\n* **Crypto Gating**: Spot volume must support perp funding spikes.",
    "context": {
      "keyTerms": [
        {
  ...
  {
    "type": "concept",
    "title": "Crypto roadway: Setup Anatomy (2)",
    "label": "Crypto Track Pillar",
  ...
  {
    "type": "concept",
    "title": "Crypto roadway: Setup Anatomy (3)",
    "label": "Crypto Track Pillar",
  ...
  {
    "type": "concept",
    "title": "Crypto roadway: Setup Anatomy (4)",
    "label": "Crypto Track Pillar",
  ...
  {
    "type": "concept",
    "title": "Crypto roadway: Setup Anatomy (5)",
    "label": "Crypto Track Pillar",
  ...
  {
    "type": "concept",
    "title": "Crypto roadway: Setup Anatomy (6)",
    "label": "Crypto Track Pillar",
  ...
  {
    "type": "practice",
    "title": "Crypto roadway: Setup Anatomy (7)",
    "label": "Crypto Track Pillar",
    "visualKey": "crypto-plan-continuous-markets",
    "body": "### Digital Asset Adaptation\n\nCrypto markets are fragmented across multiple CEX/DEX venues. The concept of **Setup Anatomy** requires checking BTC dominance and perpetual funding rates. We map the spot-perp premium.\n\n* **Crypto Gating**: Spot volume must support perp funding spikes.",
    "context": {
    ...
    "taskData": {
      "type": "choice_block",
      "question": "What is the disciplined Crypto response for Setup Anatomy?",
      "options": [
        {
          "id": "0",
  ...
  {
    "type": "summary",
    "title": "Crypto roadway: Setup Anatomy (8)",
    "label": "Crypto Track Pillar",
    "visualKey": "crypto-liquidation-invalidation",
    "body": "### Digital Asset Adaptation\n\nCrypto markets are fragmented across multiple CEX/DEX venues. The concept of **Setup Anatomy** requires checking BTC dominance and perpetual funding rates. We map the spot-perp premium.\n\n* **Crypto Gating**: Spot volume must support perp funding spikes.",
    "context": {
