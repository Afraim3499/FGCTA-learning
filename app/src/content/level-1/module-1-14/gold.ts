...
export const goldCards: LessonCard[] = [
  {
    "type": "mission_brief",
    "title": "Gold roadway: Full Plan Builder (1)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-synthesis-brief",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Full Plan Builder** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
      "keyTerms": [
        {
          "term": "Real Yields",
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Full Plan Builder (2)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-synthesis-checklist",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Full Plan Builder** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
      "keyTerms": [
        {
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Full Plan Builder (3)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-plan-builder-panel",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Full Plan Builder** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
      "keyTerms": [
        {
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Full Plan Builder (4)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-plan-audit-comparison",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Full Plan Builder** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
      "keyTerms": [
        {
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Full Plan Builder (5)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-synthesis-brief",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Full Plan Builder** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Full Plan Builder (6)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-synthesis-checklist",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Full Plan Builder** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
  ...
  {
    "type": "practice",
    "title": "Gold roadway: Full Plan Builder (7)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-plan-builder-panel",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Full Plan Builder** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
    ...
    "taskData": {
      "type": "choice_block",
      "question": "What is the disciplined Gold response for Full Plan Builder?",
      "options": [
        {
          "id": "0",
  ...
  {
    "type": "summary",
    "title": "Gold roadway: Full Plan Builder (8)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-plan-audit-comparison",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Full Plan Builder** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
