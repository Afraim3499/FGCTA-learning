...
export const goldCards: LessonCard[] = [
  {
    "type": "mission_brief",
    "title": "Gold roadway: Invalidation Planning (1)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-invalidation-foundations",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Invalidation Planning** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
      "keyTerms": [
        {
          "term": "Real Yields",
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Invalidation Planning (2)",
    "label": "Gold Track Pillar",
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Invalidation Planning (3)",
    "label": "Gold Track Pillar",
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Invalidation Planning (4)",
    "label": "Gold Track Pillar",
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Invalidation Planning (5)",
    "label": "Gold Track Pillar",
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Invalidation Planning (6)",
    "label": "Gold Track Pillar",
  ...
  {
    "type": "practice",
    "title": "Gold roadway: Invalidation Planning (7)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-invalidation-foundations",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Invalidation Planning** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
    ...
    "taskData": {
      "type": "choice_block",
      "question": "What is the disciplined Gold response for Invalidation Planning?",
      "options": [
        {
          "id": "0",
  ...
  {
    "type": "summary",
    "title": "Gold roadway: Invalidation Planning (8)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-stop-sweep-buffers",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Invalidation Planning** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
