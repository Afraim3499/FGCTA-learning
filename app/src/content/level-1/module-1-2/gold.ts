...
export const goldCards: LessonCard[] = [
  {
    "type": "mission_brief",
    "title": "Gold roadway: Plan Eligibility Filter (1)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-spike-verification-filter",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Plan Eligibility Filter** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
      "keyTerms": [
        {
          "term": "Real Yields",
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Plan Eligibility Filter (2)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-spike-verification-filter",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Plan Eligibility Filter** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Plan Eligibility Filter (3)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-spike-verification-filter",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Plan Eligibility Filter** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Plan Eligibility Filter (4)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-spike-verification-filter",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Plan Eligibility Filter** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Plan Eligibility Filter (5)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-spike-verification-filter",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Plan Eligibility Filter** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Plan Eligibility Filter (6)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-spike-verification-filter",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Plan Eligibility Filter** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
  ...
  {
    "type": "practice",
    "title": "Gold roadway: Plan Eligibility Filter (7)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-spike-verification-filter",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Plan Eligibility Filter** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
    ...
    "taskData": {
      "type": "choice_block",
      "question": "What is the disciplined Gold response for Plan Eligibility Filter?",
      "options": [
        {
          "id": "0",
  ...
  {
    "type": "summary",
    "title": "Gold roadway: Plan Eligibility Filter (8)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-spike-verification-filter",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Plan Eligibility Filter** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
