...
export const goldCards: LessonCard[] = [
  {
    "type": "mission_brief",
    "title": "Gold roadway: Area of Interest (1)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-wick-cluster-aoi",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Area of Interest** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
      "keyTerms": [
        {
          "term": "Real Yields",
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Area of Interest (2)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-wick-cluster-aoi",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Area of Interest** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Area of Interest (3)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-wick-cluster-aoi",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Area of Interest** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Area of Interest (4)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-wick-cluster-aoi",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Area of Interest** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Area of Interest (5)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-wick-cluster-aoi",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Area of Interest** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
  ...
  {
    "type": "concept",
    "title": "Gold roadway: Area of Interest (6)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-wick-cluster-aoi",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Area of Interest** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
  ...
  {
    "type": "practice",
    "title": "Gold roadway: Area of Interest (7)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-wick-cluster-aoi",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Area of Interest** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
    ...
    "taskData": {
      "type": "choice_block",
      "question": "What is the disciplined Gold response for Area of Interest?",
      "options": [
        {
          "id": "0",
  ...
  {
    "type": "summary",
    "title": "Gold roadway: Area of Interest (8)",
    "label": "Gold Track Pillar",
    "visualKey": "gold-wick-cluster-aoi",
    "body": "### Commodity Macro Adaptations\n\nGold (XAU/USD) is a highly volatile, macro-sensitive asset class. Implementing **Area of Interest** means we must coordinate yields and inflation expectations. We use Treasury yields as a fundamental filter.\n\n* **Gold Gating**: Filter out setups if yields are coiling at range extremes.",
    "context": {
