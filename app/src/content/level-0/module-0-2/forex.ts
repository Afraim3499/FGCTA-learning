...
export const forexCards: LessonCard[] = [
  {
    ...
    body: "Forex (Foreign Exchange) is decentralized. You are not looking at one universal central exchange order book; you are looking at a feed generated by a network of providers, brokers, and aggregators.",
    context: {
      keyTerms: [
  ...
  },
  {
    ...
    body: "You see EUR/USD (Euro vs. United States Dollar currency pair) move slightly upward on the chart. However, you notice the spread has widened and it is currently a low-liquidity quiet period. What is the disciplined Forex reading?",
    taskData: {
      type: "choice_block",
