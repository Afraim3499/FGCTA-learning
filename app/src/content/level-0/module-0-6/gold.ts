...
export const goldCards: LessonCard[] = [
  ...
  },
  {
    ...
    context: {
      keyTerms: [
        ...
        { term: "DXY Index", definition: "The US Dollar Index, which measures the strength of the dollar against a basket of currencies." },
  ...
  },
  {
    ...
    context: {
      keyTerms: [
        { term: "Macro Candle", definition: "A large price candle generated by sudden economic data releases or news events." },
        ...
        { term: "Yield Sensitivity", definition: "Gold's reaction to interest rate expectations, as gold yields no interest." }
      ],
