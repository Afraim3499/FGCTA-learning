...
const activityPool: Omit<ActivityItem, "id" | "time">[] = [
  ...
  { icon: "🏆", text: "Level 4 certification earned — Crypto track", color: "text-amber-400" },
  ...
  { icon: "💎", text: "Level 5 Certified Trader earned — Forex", color: "text-blue-400" },
  ...
  { icon: "🎓", text: "Level 2 certification earned — Gold track", color: "text-yellow-400" },
