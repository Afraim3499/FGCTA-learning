              ...
              <div key={lvl.level} className="flex flex-col items-center gap-3 w-1/4 group relative z-10">
                <div className="relative">
                  <div className={cn(
                    ...
                    isInProgress ? "bg-[var(--ln-teal-soft)] border-[var(--ln-teal-500)] text-[var(--ln-teal-500)] shadow-[0_0_15px_rgba(20,184,166,0.3)] scale-110" :
                ...
                <div className={cn("text-center", isInProgress ? "opacity-100" : "opacity-60")}>
                  <p className="text-[9px] font-bold text-slate-500 uppercase tracking-wider mb-0.5">
                    Lvl {lvl.level}
                  </p>
                  <p className={cn("text-[10px] font-bold px-1 line-clamp-1", isInProgress ? "text-[var(--ln-navy-900)]" : "text-slate-700")}>
                    {lvl.title}
                  </p>
                </div>
              </div>
