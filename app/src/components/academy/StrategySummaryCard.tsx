...
export function StrategySummaryCard({ summary }: StrategySummaryCardProps) {
  ...
  return (
    <div className="bg-gradient-to-r from-teal-50/40 to-emerald-50/20 border border-slate-200/80 border-l-4 border-l-[var(--ln-teal-500)] rounded-r-2xl rounded-l-md p-6 shadow-sm relative overflow-hidden group">
