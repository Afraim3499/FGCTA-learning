...
export const VISUAL_REGISTRY: Record<string, React.ComponentType<any>> = {
  ...
  "time-invalidation-clocks": dynamic(() => import("./visuals/shared-l6").then(m => m.TimeInvalidationClocks), { loading: VisualLoading }),
  ...
  "sharpe-optimizer": dynamic(() => import("./visuals/shared-l9").then(m => m.SharpeOptimizer), { loading: VisualLoading }),
  "leverage-gate-calculator": dynamic(() => import("./visuals/shared-l9").then(m => m.LeverageGateCalculator), { loading: VisualLoading }),
