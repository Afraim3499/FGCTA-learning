...
const L1Frame = ({ 
  ...
  title, 
  id, 
  mentorText: defaultMentorText = "Write your trade plans down. A professional trader does not react; they execute a pre-written plan.",
  mentorAnalogy: defaultMentorAnalogy = "A commercial airline pilot never starts a flight without a written flight plan. They don't take off and decide where to land mid-flight." 
}: { 
