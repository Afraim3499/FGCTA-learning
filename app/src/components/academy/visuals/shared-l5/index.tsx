...
const L5Frame = ({ 
  ...
  title, 
  id, 
  mentorText = "Capital preservation is the only mathematical priority. If you cannot survive the drawdown, your edge does not exist.",
  mentorAnalogy = "A nuclear reactor has secondary coolant loops and control rods. Your drawdown gear shift and daily circuit breakers are the control rods that prevent a total account meltdown." 
}: { 
