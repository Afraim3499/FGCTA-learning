  ...
  return (
    <GoldInstitutionalFrame label="Speed vs Clarity Comparator" status="LOCATION COMPARISON">
      <div className="w-full flex flex-col gap-6">
        ...
        {/* Visual Showcase */}
        <div className="w-full flex flex-col md:flex-row gap-4 bg-white p-5 rounded-3xl border border-slate-200">
    ...
    <GoldInstitutionalFrame label="Reaction Zone Behavior Simulator" status="ZONE ANALYZER">
      <div className="w-full flex flex-col gap-5">
        ...
        <div className="w-full flex flex-col md:flex-row gap-4 bg-white p-5 rounded-3xl border border-slate-200 text-left">
          ...
          {/* Candle Preview Area */}
          <div className="md:w-[220px] shrink-0 flex flex-col items-center justify-center p-4 bg-slate-50 border border-slate-200 rounded-2xl">
  ...
  return (
    <GoldInstitutionalFrame label="Sweep Decision Board" status="DECISION AUDIT">
      <div className="w-full flex flex-col gap-6">
        ...
        <div className="w-full flex flex-col md:flex-row gap-4 bg-white p-5 rounded-3xl border border-slate-200 items-center">
          {/* Graphic Side */}
          <div className="md:w-[220px] shrink-0 flex flex-col items-center justify-center p-4 bg-slate-50 border border-slate-200 rounded-2xl">
          ...
          {/* Details Side */}
          <div className="flex-1 min-w-0 text-left flex flex-col gap-4">
            {activeTab === "sweep" ? (
              <>
                <div className="flex items-center justify-between gap-4">
